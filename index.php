...
<div class="card card-outline-secondary">
     <div class="card-header">
          <b><h4 class="mb-0">Zmiana hasła</h4></b>
     </div>
     <div class="card-body">
          ...
          <div class="form-group">
               <label form="inputPasswordNewVerify">Weryfikacja:</label>
               <input type="password" class="form-control" id=inputPasswordNewVerify required="">
               <span class="form-text small text-muted">
                    Aby potwierdzić, wpisz ponownie nowe hasło.
               </span>
          </div>
          <div class="form-group">
               <button type ="submit" class="btn btn-success btn-lg float-right">Zapisz hasło</button>
